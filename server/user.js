...
router.use('/user/add', function (req, res) {
    let sql = "INSERT INTO t_user (user_name,nick_name,user_age,user_sex) VALUES(?,?,?,?);";
    console.info("user add req:", req);
    console.info("user add sql:", sql);
    let sqlParams = [
        req.body.userName,
        req.body.nickName,
        req.body.userAge,
...
/*删除*/
router.use('/user/delete', function (req, res) {
